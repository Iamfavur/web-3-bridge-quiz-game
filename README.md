...
This project is a small quiz game built with Vite, React and TypeScript.
...
- Create feature branches for separate functionality and open pull requests for each step.
- Commit frequently to show workflow.
